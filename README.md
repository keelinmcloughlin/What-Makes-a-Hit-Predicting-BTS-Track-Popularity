...
Multiple models are compared to assess both predictive performance and interpretability, with additional analysis connecting model results to BTS’s musical evolution over time.
...
Cross-validation for model comparison and selection
...
Correlated production features affect interpretation but not overall predictive insight
...
Rap-forward elements are most effective when balanced with melodic pop structures

Production intensity becomes more important as BTS transitions to global, arena-scale releases
...
BTS’s popularity reflects stylistic evolution and balance rather than a single defining sound
...
What_Makes_a_Hit_Predicting_BTS_Track_Popularity.ipynb — full analysis, modeling, and interpretation
